...
m_1 = 3 * k;
M = 5000; % Resolution
m22 = 3500;%1759, 3500, 4127, 7913, 8972, 9536
disp('--------------------------------')
kk = input('Please enter a number from 1-30: '); % High=A(:,2); Low=A(:,3); Close=A(:,4)
...
if kk == 1
    ...
    SIZE = length(b_T);
elseif kk == 2
    [A, Text, Row] = xlsread('AUDCHF_M1.csv');
    Typ_Pri = ( A(1:m22,2) + A(1:m22,3) + A(1:m22,4) ) / 3; % Typical Price
    EMA_11 = A(1,6); % 12 candels
    EMA_22 = A(1,7); % 26 candels
    MM = size(Typ_Pri,1);
    ...
    SIZE = length(b_T);
elseif kk == 3
    [A, Text, Row] = xlsread('AUDJPY_M1.csv');
    Typ_Pri = ( A(1:m22,2) + A(1:m22,3) + A(1:m22,4) ) / 3; % Typical Price
    EMA_11 = A(1,6); % 12 candels
    EMA_22 = A(1,7); % 26 candels
    MM = size(Typ_Pri,1);
...
elseif kk == 5
    ...
    SIZE = length(b_T);
elseif kk == 6
    [A, Text, Row] = xlsread('CADCHF_M1.csv');
    Typ_Pri = ( A(1:m22,2) + A(1:m22,3) + A(1:m22,4) ) / 3; % Typical Price
    EMA_11 = A(1,6); % 12 candels
    EMA_22 = A(1,7); % 26 candels
    MM = size(Typ_Pri,1);
    ...
    SIZE = length(b_T);
elseif kk == 7
    [A, Text, Row] = xlsread('CADJPY_M1.csv');
    Typ_Pri = ( A(1:m22,2) + A(1:m22,3) + A(1:m22,4) ) / 3; % Typical Price
    EMA_11 = A(1,6); % 12 candels
    EMA_22 = A(1,7); % 26 candels
    MM = size(Typ_Pri,1);
...
elseif kk == 8
    ...
    SIZE = length(b_T);
elseif kk == 9
    [A, Text, Row] = xlsread('EURCAD_M1.csv');
    Typ_Pri = ( A(1:m22,2) + A(1:m22,3) + A(1:m22,4) ) / 3; % Typical Price
    EMA_11 = A(1,6); % 12 candels
    EMA_22 = A(1,7); % 26 candels
    MM = size(Typ_Pri,1);
    ...
    SIZE = length(b_T);
elseif kk == 10
    [A, Text, Row] = xlsread('EURCHF_M1.csv');
    Typ_Pri = ( A(1:m22,2) + A(1:m22,3) + A(1:m22,4) ) / 3; % Typical Price
    EMA_11 = A(1,6); % 12 candels
    EMA_22 = A(1,7); % 26 candels
    MM = size(Typ_Pri,1);
    ...
    SIZE = length(b_T);
elseif kk == 11
    [A, Text, Row] = xlsread('EURGBP_M1.csv');
    Typ_Pri = ( A(1:m22,2) + A(1:m22,3) + A(1:m22,4) ) / 3; % Typical Price
    EMA_11 = A(1,6); % 12 candels
    EMA_22 = A(1,7); % 26 candels
    MM = size(Typ_Pri,1);
    ...
    SIZE = length(b_T);
elseif kk == 12
    [A, Text, Row] = xlsread('EURJPY_M1.csv');
    Typ_Pri = ( A(1:m22,2) + A(1:m22,3) + A(1:m22,4) ) / 3; % Typical Price
    EMA_11 = A(1,6); % 12 candels
    EMA_22 = A(1,7); % 26 candels
    MM = size(Typ_Pri,1);
    ...
    SIZE = length(b_T);
elseif kk == 13
    [A, Text, Row] = xlsread('EURNZD_M1.csv');
    Typ_Pri = ( A(1:m22,2) + A(1:m22,3) + A(1:m22,4) ) / 3; % Typical Price
    EMA_11 = A(1,6); % 12 candels
    EMA_22 = A(1,7); % 26 candels
    MM = size(Typ_Pri,1);
    ...
    SIZE = length(b_T);
elseif kk == 14
    [A, Text, Row] = xlsread('EURUSD_M1.csv');
    Typ_Pri = ( A(1:m22,2) + A(1:m22,3) + A(1:m22,4) ) / 3; % Typical Price
    EMA_11 = A(1,6); % 12 candels
    EMA_22 = A(1,7); % 26 candels
    MM = size(Typ_Pri,1);
    ...
    SIZE = length(b_T);
elseif kk == 15
    [A, Text, Row] = xlsread('GBPAUD_M1.csv');
    Typ_Pri = ( A(1:m22,2) + A(1:m22,3) + A(1:m22,4) ) / 3; % Typical Price
    EMA_11 = A(1,6); % 12 candels
    EMA_22 = A(1,7); % 26 candels
    MM = size(Typ_Pri,1);
    ...
    SIZE = length(b_T);
elseif kk == 16
    [A, Text, Row] = xlsread('GBPCHF_M1.csv');
    Typ_Pri = ( A(1:m22,2) + A(1:m22,3) + A(1:m22,4) ) / 3; % Typical Price
    EMA_11 = A(1,6); % 12 candels
    EMA_22 = A(1,7); % 26 candels
    MM = size(Typ_Pri,1);
    ...
    SIZE = length(b_T);
elseif kk == 17
    [A, Text, Row] = xlsread('GBPJPY_M1.csv');
    Typ_Pri = ( A(1:m22,2) + A(1:m22,3) + A(1:m22,4) ) / 3; % Typical Price
    EMA_11 = A(1,6); % 12 candels
    EMA_22 = A(1,7); % 26 candels
    MM = size(Typ_Pri,1);
    ...
    SIZE = length(b_T);
elseif kk == 18
    [A, Text, Row] = xlsread('GBPUSD_M1.csv');
    Typ_Pri = ( A(1:m22,2) + A(1:m22,3) + A(1:m22,4) ) / 3; % Typical Price
    EMA_11 = A(1,6); % 12 candels
    EMA_22 = A(1,7); % 26 candels
    MM = size(Typ_Pri,1);
    ...
    SIZE = length(b_T);
elseif kk == 19
    [A, Text, Row] = xlsread('NZDCAD_M1.csv');
    Typ_Pri = ( A(1:m22,2) + A(1:m22,3) + A(1:m22,4) ) / 3; % Typical Price
    EMA_11 = A(1,6); % 12 candels
    EMA_22 = A(1,7); % 26 candels
    MM = size(Typ_Pri,1);
    ...
    SIZE = length(b_T);
elseif kk == 20
    [A, Text, Row] = xlsread('NZDCHF_M1.csv');
    Typ_Pri = ( A(1:m22,2) + A(1:m22,3) + A(1:m22,4) ) / 3; % Typical Price
    EMA_11 = A(1,6); % 12 candels
    EMA_22 = A(1,7); % 26 candels
    MM = size(Typ_Pri,1);
    ...
    SIZE = length(b_T);
elseif kk == 21
    [A, Text, Row] = xlsread('NZDJPY_M1.csv');
    Typ_Pri = ( A(1:m22,2) + A(1:m22,3) + A(1:m22,4) ) / 3; % Typical Price
    EMA_11 = A(1,6); % 12 candels
    EMA_22 = A(1,7); % 26 candels
    MM = size(Typ_Pri,1);
    ...
    SIZE = length(b_T);
elseif kk == 22
    [A, Text, Row] = xlsread('NZDUSD_M1.csv');
    Typ_Pri = ( A(1:m22,2) + A(1:m22,3) + A(1:m22,4) ) / 3; % Typical Price
    EMA_11 = A(1,6); % 12 candels
    EMA_22 = A(1,7); % 26 candels
    MM = size(Typ_Pri,1);
    ...
    SIZE = length(b_T);
elseif kk == 23
    [A, Text, Row] = xlsread('USDCAD_M1.csv');
    Typ_Pri = ( A(1:m22,2) + A(1:m22,3) + A(1:m22,4) ) / 3; % Typical Price
    EMA_11 = A(1,6); % 12 candels
    EMA_22 = A(1,7); % 26 candels
    MM = size(Typ_Pri,1);
    ...
    SIZE = length(b_T);
elseif kk == 24
    [A, Text, Row] = xlsread('USDCHF_M1.csv');
    Typ_Pri = ( A(1:m22,2) + A(1:m22,3) + A(1:m22,4) ) / 3; % Typical Price
    EMA_11 = A(1,6); % 12 candels
    EMA_22 = A(1,7); % 26 candels
    MM = size(Typ_Pri,1);
    ...
    SIZE = length(b_T);
elseif kk == 25
    [A, Text, Row] = xlsread('USDJPY_M1.csv');
    Typ_Pri = ( A(1:m22,2) + A(1:m22,3) + A(1:m22,4) ) / 3; % Typical Price
    EMA_11 = A(1,6); % 12 candels
    EMA_22 = A(1,7); % 26 candels
    MM = size(Typ_Pri,1);
    ...
    SIZE = length(b_T);
elseif kk == 26
    [A, Text, Row] = xlsread('XAGUSD_M1.csv');
    Typ_Pri = ( A(1:m22,2) + A(1:m22,3) + A(1:m22,4) ) / 3; % Typical Price
    EMA_11 = A(1,6); % 12 candels
    EMA_22 = A(1,7); % 26 candels
    MM = size(Typ_Pri,1);
    ...
    SIZE = length(b_T);
elseif kk == 27
    [A, Text, Row] = xlsread('XAUUSD_M1.csv');
    Typ_Pri = ( A(1:m22,2) + A(1:m22,3) + A(1:m22,4) ) / 3; % Typical Price
    EMA_11 = A(1,6); % 12 candels
    EMA_22 = A(1,7); % 26 candels
    MM = size(Typ_Pri,1);
    ...
    SIZE = length(b_T);
elseif kk == 28
    [A, Text, Row] = xlsread('EURNZDM5_2022_04_12_03_50.xlsx');
    Typ_Pri = ( A(1:m22,2) + A(1:m22,3) + A(1:m22,4) ) / 3; % Typical Price
    EMA_11 = A(1,6); % 12 candels
    EMA_22 = A(1,7); % 26 candels
    MM = size(Typ_Pri,1);
    ...
    SIZE = length(b_T);
elseif kk == 29
    [A, Text, Row] = xlsread('CHFJPY_M1.csv');
    Typ_Pri = ( A(1:m22,2) + A(1:m22,3) + A(1:m22,4) ) / 3; % Typical Price
    EMA_11 = A(1,6); % 12 candels
    EMA_22 = A(1,7); % 26 candels
    MM = size(Typ_Pri,1);
    ...
    SIZE = length(b_T);
elseif kk == 30
    [A, Text, Row] = xlsread('GBPCAD_M1.csv');
    Typ_Pri = ( A(1:m22,2) + A(1:m22,3) + A(1:m22,4) ) / 3; % Typical Price
    EMA_11 = A(1,6); % 12 candels
    EMA_22 = A(1,7); % 26 candels
    MM = size(Typ_Pri,1);
...
elseif (NDeltaY(1,1) - tt_T(7) + 1) <= (t7_t1(1,1) / 2)
    ...
    if NDeltaY(1,1) <= MM
        ...
        x_maxE = find(MTyp_Pri == MaxTyp_PriEncounter); % Additional
        x_minE = find(MTyp_Pri == MinTyp_PriEncounter); % Additional
...
elseif (YForecast(1,1) - tt_T(7) + 1) <= (t7_t1(1,1) / 2)
    ...
    if YForecast(1,1) <= MM
        ...
        x_maxF = find(MTyp_Pri == MaxTyp_PriForecast); % Additional
        x_minF = find(MTyp_Pri == MinTyp_PriForecast); % Additional
    ...
    if Typ_Pri(Spark(7)) < First_PForecast % Hunt Up
        ...
        if MaxTyp_PriForecast <= Typ_Pri(Spark(7))
            Max_PercentF = 0;
        elseif ( Typ_Pri(Spark(7)) < MaxTyp_PriForecast ) ...
                && ( MaxTyp_PriForecast < First_PForecast )
            Max_PercentF = abs( MaxTyp_PriForecast - Typ_Pri(Spark(7)) ) * 100 / ...
                abs( First_PForecast - Typ_Pri(Spark(7)) );
        elseif MaxTyp_PriForecast >= First_PForecast
            Max_PercentF = 100;
        end
        if MinTyp_PriForecast >= Typ_Pri(Spark(7))
            Deviation_F = 0;
        elseif MinTyp_PriForecast < Typ_Pri(Spark(7))
            Deviation_F = abs( MinTyp_PriForecast - Typ_Pri(Spark(7)) ) * 100 / ...
                abs( First_PForecast - Typ_Pri(Spark(7)) );
        end
    elseif Typ_Pri(Spark(7)) > First_PForecast % Hunt Down
        ...
        if MinTyp_PriForecast >= Typ_Pri(Spark(7))
            Max_PercentF = 0;
        elseif ( Typ_Pri(Spark(7)) > MinTyp_PriForecast ) ...
                && ( MinTyp_PriForecast > First_PForecast )
            Max_PercentF = abs( MinTyp_PriForecast - Typ_Pri(Spark(7)) ) * 100 / ...
                abs( First_PForecast - Typ_Pri(Spark(7)) );
        elseif MinTyp_PriForecast <= First_PForecast
            Max_PercentF = 100;
        end
        if MaxTyp_PriForecast <= Typ_Pri(Spark(7))
            Deviation_F = 0;
        elseif MaxTyp_PriForecast > Typ_Pri(Spark(7))
            Deviation_F = abs( MaxTyp_PriForecast - Typ_Pri(Spark(7)) ) * 100 / ...
                abs( First_PForecast - Typ_Pri(Spark(7)) );
        end
...
hold on
p7 = plot(x_maxE+Spark(7),MaxTyp_PriEncounter,'gp','linewidth',1.5); % Additional
hold on
plot(x_minE+Spark(7),MinTyp_PriEncounter,'gp','linewidth',1.5); % Additional
hold on
X_1 = [Spark(7), Spark(7)];
...
x_curve2 = Spark(7) + 1 : NDeltaY(1,3);
...
y20 = y16(x_curve2) + max_dis1/2;
y21 = y16(x_curve2) - max_dis1/2;

% y22 = y17(x_curve2) + (max_dis2 + average2) / 2;
% y23 = y17(x_curve2) - (max_dis2 + average2) / 2;
y22 = y17(x_curve2) + max_dis2/2;
y23 = y17(x_curve2) - max_dis2/2;

LifeTime1 = -1; LifeTime2 = -1;
if NDeltaY(1,3) <= MM
    for i = Spark(7) + 1 : NDeltaY(1,3) - 1
...
hold on
p7 = plot(x_maxF+Spark(7),MaxTyp_PriForecast,'gp','linewidth',1.5); % Additional
hold on
plot(x_minF+Spark(7),MinTyp_PriForecast,'gp','linewidth',1.5); % Additional
hold on
X_1 = [Spark(7), Spark(7)];
p8 = line(X_1,Y_1,'Color',[.3 .9 .9]); % Additional
hold on
...
x_curve2 = Spark(7) + 1 : YForecast(1,3);
...
y24 = y18(x_curve2) + max_dis1/2;
y25 = y18(x_curve2) - max_dis1/2;

% y26 = y19(x_curve2) + (max_dis2 + average2) / 2;
% y27 = y19(x_curve2) - (max_dis2 + average2) / 2;
y26 = y19(x_curve2) + max_dis2/2;
y27 = y19(x_curve2) - max_dis2/2;

LifeTime1 = -1; LifeTime2 = -1;
if YForecast(1,3) <= MM
    for i = Spark(7) + 1 : YForecast(1,3) - 1
...
elseif (NDeltaY(ii-1,1) - tt_T(ii+5) + 1) <= (t7_t1(ii-1,1) / 2)
    ...
    if NDeltaY(ii-1,1) <= MM
        ...
        x_maxE = find(MTyp_Pri == MaxTyp_PriEncounter(ii-1,1)); % Additional
        x_minE = find(MTyp_Pri == MinTyp_PriEncounter(ii-1,1)); % Additional
...
elseif (YForecast(ii-1,1) - tt_T(ii+5) + 1) <= (t7_t1(ii-1,1) / 2)
    ...
    if YForecast(ii-1,1) <= MM
        ...
        x_maxF = find(MTyp_Pri == MaxTyp_PriForecast(ii-1,1)); % Additional
        x_minF = find(MTyp_Pri == MinTyp_PriForecast(ii-1,1)); % Additional
    ...
    if Typ_Pri(Spark(ii+5)) < First_PForecast(ii-1,1) % Hunt Up
        ...
        if MaxTyp_PriForecast(ii-1,1) <= Typ_Pri(Spark(ii+5))
            Max_PercentF(ii-1,1) = 0;
        elseif ( Typ_Pri(Spark(ii+5)) < MaxTyp_PriForecast(ii-1,1) ) ...
                && ( MaxTyp_PriForecast(ii-1,1) < First_PForecast(ii-1,1) )
            Max_PercentF(ii-1,1) = abs( MaxTyp_PriForecast(ii-1,1) - Typ_Pri(Spark(ii+5)) ) * 100 / ...
                abs( First_PForecast(ii-1,1) - Typ_Pri(Spark(ii+5)) );
        elseif MaxTyp_PriForecast(ii-1,1) >= First_PForecast(ii-1,1)
            Max_PercentF(ii-1,1) = 100;
        end
        if MinTyp_PriForecast(ii-1,1) >= Typ_Pri(Spark(ii+5))
            Deviation_F(ii-1,1) = 0;
        elseif MinTyp_PriForecast(ii-1,1) < Typ_Pri(Spark(ii+5))
            Deviation_F(ii-1,1) = abs( MinTyp_PriForecast(ii-1,1) - Typ_Pri(Spark(ii+5)) ) * 100 / ...
                abs( First_PForecast(ii-1,1) - Typ_Pri(Spark(ii+5)) );
        end
    elseif Typ_Pri(Spark(ii+5)) > First_PForecast(ii-1,1) % Hunt Down
        ...
        if MinTyp_PriForecast(ii-1,1) >= Typ_Pri(Spark(ii+5))
            Max_PercentF(ii-1,1) = 0;
        elseif ( Typ_Pri(Spark(ii+5)) > MinTyp_PriForecast(ii-1,1) ) ...
                && ( MinTyp_PriForecast(ii-1,1) > First_PForecast(ii-1,1) )
            Max_PercentF(ii-1,1) = abs( MinTyp_PriForecast(ii-1,1) - Typ_Pri(Spark(ii+5)) ) * 100 / ...
                abs( First_PForecast(ii-1,1) - Typ_Pri(Spark(ii+5)) );
        elseif MinTyp_PriForecast(ii-1,1) <= First_PForecast(ii-1,1)
            Max_PercentF(ii-1,1) = 100;
        end
        if MaxTyp_PriForecast(ii-1,1) <= Typ_Pri(Spark(ii+5))
            Deviation_F(ii-1,1) = 0;
        elseif MaxTyp_PriForecast(ii-1,1) > Typ_Pri(Spark(ii+5))
            Deviation_F(ii-1,1) = abs( MaxTyp_PriForecast(ii-1,1) - Typ_Pri(Spark(ii+5)) ) * 100 / ...
                abs( First_PForecast(ii-1,1) - Typ_Pri(Spark(ii+5)) );
        end
...
hold on
p7 = plot(x_maxE+Spark(ii+5),MaxTyp_PriEncounter(ii-1,1),'gp','linewidth',1.5); % Additional
hold on
plot(x_minE+Spark(ii+5),MinTyp_PriEncounter(ii-1,1),'gp','linewidth',1.5) % Additional
hold on
...
%---------------------------  Life time (no noise)  -----------------------
%x_curve1 = Sol_Total(1,11) : NDeltaY(1,3);
x_curve2 = Spark(ii+5) + 1 : NDeltaY(ii-1,3);
...
LifeTime1 = -1; LifeTime2 = -1;
if NDeltaY(ii-1,3) <= MM
    for i = Spark(ii+5) + 1 : NDeltaY(ii-1,3) - 1
...
hold on
p7 = plot(x_maxF+Spark(ii+5),MaxTyp_PriForecast(ii-1,1),'gp','linewidth',1.5); % Additional
plot(x_minF+Spark(ii+5),MinTyp_PriForecast(ii-1,1),'gp','linewidth',1.5) % Additional
hold on
X_1 = [Spark(ii+5), Spark(ii+5)];
p8 = line(X_1,Y_1,'Color',[.3 .9 .9]); % Additional
hold on
...
%---------------------------  Life time (with noise)  -----------------------
%x_curve1 = Sol_Total(1,11) : YForecast(1,3);
x_curve2 = Spark(ii+5) + 1 : YForecast(ii-1,3);
...
LifeTime1 = -1; LifeTime2 = -1;
if YForecast(ii-1,3) <= MM
    for i = Spark(ii+5) + 1 : YForecast(ii-1,3) - 1
...
T = table(CT_1, DT_1, ST_1, De_1, Extreme_distance_with_spark_1, Phase_change_time_1, Pr_1, ...
    ...
    XNUD_Forecast, Hunt_Forecast, Deviation_F, Max_PercentF, ...
    ...
    LifeTimeA, LifeTimeB );
writetable(T,'Final_Result_.csv')
writetable(T,'Final_Result_.xlsx')
